<?php 
    ...
    foreach ($CategoryHome as $item) {
        ...
        $sql = "SELECT * FROM product  ORDER BY (price*(100 - sale)/100) DESC ";
    ...
    <div class="container">
        <div class="row list-product">
            ...
            <div class="info-product col-9">
                <div class="row">
                    <div class="col-9">
                        <h2>Sắp xếp: <?php echo  'Giá giảm dần' ?></h2>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 pl-0">
                                    <select class="form-control form-control-sm" onchange="location = this.value;">
                                        ...
                                        <option selected="selected" value="<?php echo url_home()?>/filter-dsc.php">Giá
                                            giảm dần</option>
                                    </select>
                                </div>
                            </div>
