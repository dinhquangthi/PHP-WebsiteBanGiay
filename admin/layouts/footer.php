 <!-- /#page-wrapper -->
    ...
    <!-- jQuery -->
    <script src="<?php echo url_home() ?>/public/admin/js/jquery.js"></script>
    ...
    <script src="<?php echo url_home() ?>/public/admin/js/plugins/morris/morris.min.js"></script>
    <script src="<?php echo url_home() ?>/public/admin/js/plugins/morris/morris-data.js"></script>
