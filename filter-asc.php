<?php 
    ...
    foreach ($CategoryHome as $item) {
        ...
        $sql = "SELECT * FROM product  ORDER BY (price*(100 - sale)/100) ASC ";
    ...
    <div class="container">
        <div class="row list-product">
            ...
            <div class="info-product col-9">
                <div class="row">
                    <div class="col-9">
                        <h2>Sắp xếp: <?php echo  'Giá tăng dần' ?></h2>
                    </div>
                    <div class="col-4 mr-4">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-4 pt-1 pr-0">
                                    <h6 for="exampleFormControlSelect1">Sắp xếp:</h6>
                                </div>
                                <div class="col-8 pl-0">
                                    <select class="form-control form-control-sm" onchange="location = this.value;">
                                        ...
                                        <option selected="selected" value="<?php echo url_home()?>/filter-asc.php">Giá tăng dần</option>
                    ...
                    <div class="search-product col-3">
                        <form action="search.php" method="GET">
                            <input type="text" name="search-product" placeholder="Tìm kiếm sản phẩm...">
                ...
                <nav aria-label="Page navigation example ">
                    <ul class="pagination justify-content-center">
                        ...
                        <a class="page-link pagi <?php echo ($i == $p) ? 'active ' : '' ?>"
